...
def launch_setup(context, *args, **kwargs):
    ...
    base_params = {
        ...
        'pointcloud_frame_id': LaunchConfiguration('pointcloud_frame_id').perform(context),
    }
    ...
    static_tf_node = Node(
        ...
        arguments=['0', '0', '0', '1.57', '0', '3.14', 'oakd_imu_link', 'oakd_camera_optical_frame']
    )
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument('params_file', default_value='', description='YAML参数文件的路径'),
        ...
        DeclareLaunchArgument('pointcloud_frame_id', default_value='oakd_camera_optical_frame'),
